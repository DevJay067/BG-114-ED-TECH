...
npm install
Environment Configuration: Create a .env file from the provided .env.example:
PORT=5000
FIREBASE_PROJECT_ID=bg-114
CLIENT_URL=http://localhost:5500
Firebase Credentials: Place your serviceAccountKey.json from the Firebase Console into the root of this folder.
Launch:
...
Check that the FIREBASE_PROJECT_ID in .env matches your firebase-config.js.
